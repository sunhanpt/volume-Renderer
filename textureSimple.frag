...
vec3 voxelSize ;                // dimensions in voxels in each direction
float raystep ;         // minimum ray step to take (in voxels)
float opticalScale ;      // scale between geometric size and optical depth
